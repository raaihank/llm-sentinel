...
exports.disableDebugLogging = disableDebugLogging;
exports.toggleNotifications = toggleNotifications;
exports.disableAllDetection = disableAllDetection;
exports.enableAllDetection = enableAllDetection;
...
async function startServer(options) {
    ...
    if (options.daemon) {
        ...
        // Run in foreground
        const server = new proxy_server_1.ProxyServer({
            port,
...
function stopServer() {
    ...
    function forceKillProcesses() {
        ...
        if (os.platform() === 'win32') {
            ...
            killByPort.stdout.on('data', (data) => {
